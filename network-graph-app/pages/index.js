...
const edgeTypes = ['wired', 'dataflow'];
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Box
        ...
        sx={{
          ...
          p: 3,
          boxSizing: 'border-box',
          marginTop: 0 + (isRibbonOpen ? RIBBON_HEIGHT : 0),
          minHeight: `calc(100vh - 0px - ${isRibbonOpen ? RIBBON_HEIGHT : 0}px)`
        }}
      >
        <Toolbar />
        <Box sx={{ display: 'flex', height: 'calc(100% - 0px)' }}>
          <NetworkGraph
